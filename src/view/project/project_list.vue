    ...
    <div class="project_list">
    	<div class="project_list-top">
            ...
            class="input-select"
              ...
              clearable
              placeholder="负责人"
              v-model="search.createorId"
              >
            </el-cascader>
            <el-select v-model="search.status" clearable class="input-select" size="mini" placeholder="项目状态">
                <el-option
            ...
            <el-button size="mini" @click="getselectdata" type="primary">搜索</el-button>
            <el-button size="mini" @click="clear" type="primary">重置</el-button>

            

            <el-button size="mini" @click="projectadd.dialogVisible = true" type="primary"> + 创建项目</el-button>
        </div>

        <div class="project_list-middle">
          <el-table
            :data="tableData"
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                  ...
                  <el-progress v-if="scope.row.finishRate" :text-inside="true" :stroke-width="18" :percentage="scope.row.finishRate"></el-progress>

                  <el-progress v-else :text-inside="true" :stroke-width="18" :percentage="0"></el-progress>
        ...
        <el-dialog
          ...
          <div  v-show="!filethird.upload" class="filethird_body">
            ...
            <p v-for="(list,index) in filethird.filelist">
              ...
              <a :download="`${list.filePath}`" target="_blank" :href="`http://hzyymy.cn/${list.filePath}`" >{{list.fileName}}</a>
        ...
        <projectcomdetail @getselectdata="getselectdata" :id="detailproject.id"  @close="projectcomdetail_dialogVisible = false" :dialogVisible="projectcomdetail_dialogVisible"></projectcomdetail>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        filethirdupload () {
          ...
          this.filethird.dialogVisiblemission = true
        },
        filethirdlook () {
      ...
      dblclickdetail(index,row) {
          ...
          this.detailproject.id = index.id
        ...
        let that = this
          ...
          this.$http.post(`project/add_project`, {
            ...
            .then(function (data) {
              ...
              that.projectadd.projectName = ''
              that.projectadd.memo = ''
              that.projectadd.endTime = ''
              that.projectadd.projectLevel = ''
      ...
      getselectdata() {
        ...
        this.$http.post(`project/find_project_list`,{
            ...
            status: this.search.status,
            createorId: this.search.createorId.length>0 ? this.search.createorId[this.search.createorId.length-1]: '',
